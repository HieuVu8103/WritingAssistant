      ...
      messages: [
        {
          role: "system",
          content:
            "Given an English input text, you are tasked is paraphrase the input text in 3 version. Do not include any introductory or explanatory phrases.",
        },
...
const parseResponses = (response) => {
  ...
  return filteredVersions.slice(0, 3);  
};
